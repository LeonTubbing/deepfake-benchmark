"""
Xception deepfake detector training script.
...
print(f"Initial training took {(time.time() - start_time)/60:.2f} minutes.")
...
print(f"Fine-tuning took {(time.time() - start_time)/60:.2f} minutes.")

# Save the trained model
model.save('deepfake_detection_model_xception_FF+C40.h5')
print("Model saved as 'deepfake_detection_model_xception_FF+C40.h5'")
